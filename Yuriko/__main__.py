...
yumi_IMG = "https://telegra.ph/file/f4178dd3d119c019337e0.jpg"

PM_START_TEXT = """
*👋 Hello {}*

Hey There My Name Is *Dyna* [I](https://telegra.ph/file/f4178dd3d119c019337e0.jpg) Am Here To Help You Manage Your Groups!
Hit /Help To Find Out More About How To Use Me To My Full Potential!
────────────────────────
乂 Ping Time: {}
乂 {} User, Database {} Chats.
────────────────────────
*Powered By: @DYNA_NETWORK*
"""
...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(
            text="SᴏᴜʀᴄᴇCᴏᴅᴇ", url="PHLE 500 RUPEES PAYTM ME DE"
        ),
    ],
    [
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_photo(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="Sᴜᴘᴘᴏʀᴛ", url="https://t.me/DYNA_SUPPORT")]]
            ),
        )
...
def yurikorobot_about_callback(update, context):
    ...
    if query.data == "yurikorobot_":
        query.message.edit_text(
            text=""" *SECURITY* - `A bot to manage your groups with additional features!`
            \n`Here the basic help regarding use of dynarobot.`
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Bᴜɢ'ꜱ", url="https://t.me/DYNA_NETWORK"
                        ),
                        InlineKeyboardButton(
                            text="Bᴏᴛ Lɪꜱᴛ", url="https://t.me/DYNA_NETWORK"
                        ),
                    ],
        ...
        query.message.edit_text(
            ...
            f"\n✗ `Than send` `/admincache@DYNASECURITY_DBOT` `in that chat to refresh admin list in My database.`\n"
        ...
        query.message.edit_text(
            ...
            f"\n\n✗ *Lets Enjoy The DYNA Music And Join Support Group @DYNA_SUPPORT*"
            f"\n\n*✗ Pᴏᴡᴇʀᴇᴅ 💕 Bʏ: DYNA NETWORK!*",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="Back", callback_data="yurikorobot_back")]]
        ...
        query.message.edit_text(
            ...
            f"\n✗ `Congragulations, DYNA now ready to manage your group.`"
            f"\n\n*Admin Tools*"
            f"\n✗ `Basic Admin tools help you to protect and powerup your group.`"
            f"\n✗ `You can ban members, Kick members, Promote someone as admin through commands of bot.`"
            f"\n\n*Welcome*"
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Lᴏɢ'ꜱ", url="t.me/DYNA_LOGS"),
                    InlineKeyboardButton(text="Nᴇᴡꜱ", url="t.me/DYNA_NETWORK"),
                 ],
                 [
                    InlineKeyboardButton(text="Sᴜᴘᴘᴏʀᴛ", url="https://t.me/DYNA_SUPPORT"),
                    InlineKeyboardButton(text="Uᴘᴅᴀᴛᴇꜱ", url="https://t.me/DYNA_NETWORK"),
                 ],
                 [
                    InlineKeyboardButton(text="Back", callback_data="yurikorobot_basichelp"),
        ...
        query.message.edit_text(
            text=f"<b> CREDIT FOR DYNA DEV'S</b>\n"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Dyna", url="t.me/DYNA_OPTIMISE"),
                    InlineKeyboardButton(text="Repo", url="t.me/DYNA_NETWORK"),
                 ],
                 [
                    InlineKeyboardButton(text="Back", callback_data="yurikorobot_basichelp"),
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 5404948539 and DONATION_LINK:
            update.effective_message.reply_text(
