...
def set_sticker(update: Update, context: CallbackContext):
    ...
    if user_can_changeinfo(chat, user, context.bot.id) is False:
        return msg.reply_text("You have no right to change, tere liye sharam ki baat hai")
...
def setchat_title(update: Update, context: CallbackContext):
    ...
    title = " ".join(args)
    if not title:
        msg.reply_text("Kuch text do taaki mai new set title kar saku chat me!😴")
        return
...
def promote(update: Update, context: CallbackContext) -> str:
    ...
    if (
        ...
        message.reply_text("Bhai,Bhen jo bhi ho apke pass ye right na ha sorry aur so shameless you are saste admin  🙂 dil se bura laga support @DYNA_SUPPORT")
        return
    ...
    if user_member.status in ('administrator', 'creator'):
        message.reply_text("How ?? mltb ma fhir se usko admin banaun jabki already admin ha🥺")
        return
...
def lowpromote(update: Update, context: CallbackContext) -> str:
    ...
    if (
        ...
        message.reply_text("Bhai,Bhen jo bhi ho apke pass ye right na ha sorry 🙂 dil se bura laga support @DYNA_SUPPORT ")
        return
