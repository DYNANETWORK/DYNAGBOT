...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/f4178dd3d119c019337e0.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/DYNASECURITY_DBOT"),
        InlineKeyboardButton(
    ...
    msg = f"""
**[DYNA Robot ❤️](https://t.me/DYNA_SUPPORT):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/DYNA_SUPPORT)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
...
async def music_inline_func(answers, query):
    chat_id = -1001688554501
    group_invite = "https://t.me/DYNA_SUPPORT"
    try:
        messages = [
            m
